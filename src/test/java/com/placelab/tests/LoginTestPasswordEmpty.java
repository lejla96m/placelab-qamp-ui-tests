...
public class LoginTestPasswordEmpty {
    ...
    public void testPositiveLogin(final String email) {
        ...
        Assert.assertEquals(actualMessage, expectedMessage, "Validate the error message when a password is not provided");

        System.out.println("Error message is displayed when a password is not provided and the text is: " + actualMessage);
    }
